...
**Источники (ОБЯЗАТЕЛЬНО — таблица для каждого наблюдения):**
| Тип | Документ | Стр. | Цитата |
|-----|----------|------|--------|
| Evidence | [имя файла] | [N] | "[прямая цитата из источника]" |
| L1 (Регулятор) | [файл] | [N] | "[точный текст требования]" |
| L2 (Аудит) | [файл] | [N] | "[текст стандарта]" |
| L3 (Локальный) | [файл или N/A] | [N] | "[политика или N/A]" |

⚠️ ВАЖНО: БЕЗ ИСКЛЮЧЕНИЙ — каждое наблюдение ДОЛЖНО иметь таблицу "Источники" с реальными цитатами.
Если цитата не найдена в материалах, пиши N/A, но не пропускай таблицу."""
        return prompt
